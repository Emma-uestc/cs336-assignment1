...
class BPETrainer:
    ...
    def train(self,
        ...
        Args:
            ...
            vocab_size: int, total number of token
            special_tokens: List[str], the special tokens list
        Returns:
            vocablulary: Dict[int, bytes], vocabulary of the BPE Trainer
            merges: List[Tuple[bytes, bytes]], merge rules of the BPE Trainer
        """
    ...
    def count_pairs(self,
        ...
        Returns:
            pair_counts: Dict[Tuple[int, int],int], the frequency of each adjacent pair
        """
