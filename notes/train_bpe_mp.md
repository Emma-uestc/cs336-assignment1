...
![](_assets/Pasted-image-20260519111916.png)
...
![](_assets/Pasted-image-20260519190744.png)
...
### 图示概览
![](_assets/Pasted-image-20260519193900.png)
...
![](_assets/Pasted-image-20260520151135.png)

2. 训练结果
![](_assets/Pasted-image-20260520151744.png)

## 修复后性能分析
修复 bug 后，从 profile 看，pretokenize 花费时间更长了：
![](_assets/Pasted-image-20260520160301.png)




![](_assets/Pasted-image-20260520161618.png)
...
![](_assets/Pasted-image-20260520200736.png)
很快就一个进程在跑了
![](_assets/Pasted-image-20260520201022.png)

### 性能分析
有提升
![](_assets/Pasted-image-20260520201131.png)

优化后确实明显提高，性能分析概览：
![](_assets/Pasted-image-20260520211626.png)
pretokenize 由之前的 153s 降低到 77s,提升了 50%




![](_assets/Pasted-image-20260521201117.png)
...
![](_assets/Pasted-image-20260522153638.png)

![](_assets/Pasted-image-20260522153655.png)
...
![](_assets/Pasted-image-20260522165402.png)

![](_assets/Pasted-image-20260522165454.png)
...
![](_assets/Pasted-image-20260523114313.png)
...
![](_assets/Pasted-image-20260523143535.png)

![](_assets/Pasted-image-20260523143444.png)

![](_assets/Pasted-image-20260523143617.png)
### 成果总结
...
![](_assets/Pasted-image-20260523151142.png)
...
![](_assets/Pasted-image-20260524204100.png)
...
![](_assets/Pasted-image-20260525094700.png)

![](_assets/Pasted-image-20260525095149.png)

#### **改进 v1 训练结果**
再次陷入 OOM
![](_assets/Pasted-image-20260525214804.png)
9 个多小时的还没完成，查看进程还在跑，结果差不多两个小时后查看 CPU 时间与 9 个多小时时相同。
#### **改进 v1 分析**
查看 OOM 情况，确实有被 OOM 的，但是不是当前运行的子进程。难道是多进程死锁？
dmesg -T | grep -i -E "oom|kill"
![](_assets/Pasted-image-20260525221355.png)
...
![](_assets/Pasted-image-20260526171006.png)


我让 AI 画了个图，一开始它把找不到 special token 的分支画错了（吐槽下）
![](_assets/Pasted-image-20260528082827.png)
关键实现代码
- cpu 自适应
...
![](_assets/Pasted-image-20260527183200.png)

忘了加 profile 参数了，只好重新跑一遍🤡
#### **v2 profile **
![](_assets/Pasted-image-20260528083621.png)

![](_assets/Pasted-image-20260528092931.png)
#### OWT 训练总览
